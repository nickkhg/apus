...
// events through them.
#ifndef MYDISTRO_UINPUT_SHIM_H
#define MYDISTRO_UINPUT_SHIM_H
...
extern const uint16_t mydistro_ev_key;
extern const uint16_t mydistro_ev_abs;
extern const uint16_t mydistro_ev_syn;
extern const uint16_t mydistro_syn_report;
extern const uint16_t mydistro_abs_x;
extern const uint16_t mydistro_abs_y;
extern const uint16_t mydistro_btn_left;
extern const int32_t mydistro_abs_maximum;
