...
// The colours and the sizes of Files. They are the colours of the design,
...
public enum Ink {
    ...
    /// The mark of the app, in its bundle as well, and the colour of a
    /// folder.
    public static let mark = Color(hex: 0xE0A458)
...
enum Metrics {
    static let sidebarWidth: Double = 184
    static let head: Double = 52
    static let row: Double = 32
    static let kindWidth: Double = 150
    static let compactKindWidth: Double = 104
    static let sizeWidth: Double = 76
}
